function [] = estimateBasisFctParametersGA(obj)
% Find the optimal parameter Set using a genetic algortihm as solver
% and the Kriging parameter estimation objective function
% 
...
% See the license note at the end of the file.
    ...
    obj.setBasisFctParameters(obj.InitialBasisFctParameters);

    obj.covariance_zero = [];   
    
    if obj.UseAuxiliaryCondition
       [optPara minError] ...
         = ga(@obj.calcKrigingParaEstimationObjFct,obj.nBasisFctParameters,...
                   [],[],[],[],...
