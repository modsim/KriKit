function [options] = setOptionsFminUnc(obj)
% [options] = setOptionsFminUnc()
...
% See the license note at the end of the file.
   ...
   try
        ...
        options = optimoptions(@fminunc,'Display',showDetails,'UseParallel',strParallel{1},'MaxIter',obj.nIterationsSolver);
   catch
        options = optimset('Display',showDetails,'UseParallel','always','MaxIter',obj.nIterationsSolver);
   end
end
