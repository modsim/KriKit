function [options] = setOptionsFminCon(obj)
% [options] = setOptionsFminCon()
...
% See the license note at the end of the file.
   ...
   try
        ...
        options = optimoptions(@fmincon,'Algorithm','sqp',...
                               ...
                               'MaxIter',obj.nIterationsSolver,...
                               'FinDiffRelStep',1e-8);
   catch
        options = optimset('Algorithm','sqp','Display',showDetails,'UseParallel','always','MaxIter',obj.nIterationsSolver);
   end
end
